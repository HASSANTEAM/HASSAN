...
local text = text:gsub('username',(result.username_ or 'X_A_C_56'))
...
local text = text:gsub('username',(msg.content_.members_[0].username_ or 'X_A_C_56'))
Dev_Abs(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end
--        Contact         --
...
if text and (text:match("عيري بعائشه القحبه ") or text:match("عمر يتداوى بماء الرجال") or text:match("لعن الله ابو بكر وعمر وعثمان") or text:match("عمر و ابوبكر كفاران") or text:match("عائشه تدخل الرجال ببيتها") or text:match("عمر ابن زنا") or text:match("الشاب الأيفع") or text:match("عمر ليس لديه نسب") or text:match("يزيد يشرب خمر") or text:match("كس امكم") or text:match("الشاب الايفع") or text:match("أسما تزوجت متعه") or text:match("مرضعه") or text:match("مرضعة") or text:match("الكحبه") or text:match("رضاعة") or text:match("ابن الرضاعه") or text:match("كس امك") or text:match("ابن الرضاعة") or text:match("كس اختك")) then
...
if text and (text:match("عمر جبان") or text:match("عمر هارب") or text:match("عائشه زانيه") or text:match("عمر فرار") or text:match("ابن صهاك") or text:match("صهاك") or text:match("عاءشه زانيه") or text:match("عاءشة زانية") or text:match("مرضعة") or text:match("مرضعه") or text:match("هلاك عائشة") or text:match("هلاك عائشه") or text:match("العن عائشه") or text:match("العن عائشة") or text:match("كسمك") or text:match("عير") or text:match("عمر منيوج") or text:match("عمر ديوث") or text:match("رضاع الرجال") or text:match("رضاعة") or text:match("مرضعة") or text:match("مرضعه") or text:match("نزل بعائشه") or text:match("نزل بعائشة") or text:match("لعن الله هند") or text:match("اكلت الاكباد هند") or text:match("معاويه يشرب خمر") or text:match("معاوية يشرب عرك") or text:match("يزيد يشرب عرك") or text:match("لعن الله ابوبكر") or text:match("عمر منكوح")) then
if DevAbs:get(HASSAN.."Abs:Lock:Farsi"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","⌁︙يا رافضي يا كلب لا تسب تاج رأسك ورأس نرجس المتمتعة يا عفير هذا الذي قمت بسبه نعله يشرفك انت وبلدك يا ابن المتعة يا حيوان")  
end end
if text and (text:match("رضاع الزلم") or text:match("لعنالله ابوبكر") or text:match("لعنت الله ابن صهاك") or text:match(" ابن صهاك منكوح") or text:match("صهاكك") or text:match("رجل نزل بعائشة") or text:match("ممية") or text:match("مميه") or text:match("عمر منكوح") or text:match("لعن الله ال اميه") or text:match("عمر منافق") or text:match("معاويه يحتسي الخمر ") or text:match("يزيد يحتسي الخمر") or text:match("نزل بعائشه") or text:match("لعن الوهابيه") or text:match("لعن الوهابية") or text:match("عيوشه كحبه") or text:match("عيوشة كحبه") or text:match("عيوشة قحبة") or text:match("عيوشه قحبه") or text:match("هلاك عمر") or text:match("هلاك ابو بكر") or text:match("هلاك ابوبكر") or text:match("هلاك عثمان") or text:match("هلاك معاويه") or text:match("هلاك معاوية") or text:match("هلاك حفصه") or text:match("هلاك حفصة") or text:match("هنوده") or text:match("هنودة") or text:match("مناويك")) then
...
if text == "الدردشه" then if DevAbs:get(HASSAN..'Abs:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local HASSANTEAM = "\n" .."⌁︙الدردشه ↫ "..mute_text.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, HASSANTEAM, 1, 'md') end
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/X_A_C_56' end
...
ConstructorAbs = "["..Abs.first_name_.."](T.me/"..(Abs.username_ or "X_A_C_56")..")"
else 
