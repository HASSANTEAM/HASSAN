...
if text and (text:match("ڬ") or text:match("ٺ") or text:match("چ") or text:match("ڇ") or text:match("ڿ") or text:match("ڀ") or text:match("ڎ") or text:match("ݫ") or text:match("ژ") or text:match("ڟ") or text:match("ݜ") or text:match("ڸ") or text:match("پ") or text:match("۴") or text:match("مک") or text:match("زدن") or text:match("عمر منافق") or text:match("عمر ديوث") or text:match("رضاع الكبير") or text:match("رضاعة") or text:match("مرضعة") or text:match("مرضعه") or text:match("نزل بعائشه") or text:match("نزل بعائشة") or text:match("لعن الله هند") or text:match("اكلت الاكباد") or text:match("معاويه يشرب خمر") or text:match("معاوية يشرب خمر") or text:match("يزيد يشرب الخمر") or text:match("لعن الله ابوبكر") or text:match("صهاك")) then
...
if text and (text:match("رضاع الكبير") or text:match("لعن الله ابوبكر") or text:match("لعن الله ابن صهاك") or text:match("ابن صهاك") or text:match("صهاك") or text:match("نزل بعائشة") or text:match("مرضعة") or text:match("رضاع") or text:match("مرضعه") or text:match("اكلت الاكباد") or text:match("عمر منافق") or text:match("معاويه يشرب خمر") or text:match("يزيد يشرب خمر") or text:match("نزل بعائشه") or text:match("مک") or text:match("زدن") or text:match("دخترا") or text:match("دیوث") or text:match("کلیپشن") or text:match("خوششون") or text:match("میدا") or text:match("که") or text:match("بدانیم") or text:match("باید") or text:match("زناشویی") or text:match("آموزش") or text:match("راحتی") or text:match("خسته") or text:match("بیام") or text:match("بپوشم") or text:match("كرمه")) then
