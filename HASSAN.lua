...
if text and (text:match("لعن") or text:match("لعنت") or text:match("لعنه") or text:match("لعنة") or text:match("نكح") or text:match("منكوحه") or text:match("منكوحة") or text:match("عيوشه") or text:match("عيوشة") or text:match("منكوح") or text:match("بكوس") or text:match("كوس") or text:match("بعنابت") or text:match("عنابه") or text:match("عنابة") or text:match("ايفع") or text:match("عمر منيوج") or text:match("عمر ديوث") or text:match("رضاع الرجال") or text:match("رضاعة") or text:match("مرضعة") or text:match("مرضعه") or text:match("نزل بعائشه") or text:match("نزل بعائشة") or text:match("لعن الله هند") or text:match("اكلت الاكباد هند") or text:match("معاويه يشرب خمر") or text:match("معاوية يشرب عرك") or text:match("يزيد يشرب عرك") or text:match("لعن الله ابوبكر") or text:match("عمر منكوح")) then
if DevAbs:get(HASSAN.."Abs:Lock:Farsi"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","⌁︙ممنوع سب ولعن الرموز هنا قال النبي صل الله عليه وسلم ليس المؤمن بالطعان ولا اللعان ولا الفاحش ولا البذيء وقال أيضا لا تلاعنوا بلعنة الله ولا بغضبه ولا بالنار وقال أيضا إن اللعانين لا يكونون شهداء ولا شفعاء يوم القيامة اتبعو أخلاق نبيكم محمد صل الله عليه وآله وسلم")  
end end
if text and (text:match("رضاع الزلم") or text:match("لعنالله ابوبكر") or text:match("لعنت الله ابن صهاك") or text:match(" ابن صهاك منكوح") or text:match("صهاكك") or text:match("رجل نزل بعائشة") or text:match("ممية") or text:match("مميه") or text:match("عمر منكوح") or text:match("لعن الله ال اميه") or text:match("عمر منافق") or text:match("معاويه يحتسي الخمر ") or text:match("يزيد يحتسي الخمر") or text:match("نزل بعائشه") or text:match("ناج") or text:match("طيز") or text:match("ينيج") or text:match("دیوث") or text:match("منيوجج") or text:match("شك") or text:match("بعص") or text:match("مبعوص") or text:match("بعبص") or text:match("زانيه") or text:match("زانيه") or text:match("الزانيه") or text:match("الزانية") or text:match("تزني") or text:match("زنت") or text:match("شوف عائشه") or text:match("عند عائشه")) then
