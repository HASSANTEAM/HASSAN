...
if text and (text:match("عيري بعائشه القحبه ") or text:match("عمر يتداوى بماء الرجال") or text:match("لعن الله ابو بكر وعمر وعثمان") or text:match("عمروابوبكر كفار") or text:match("عائشه تدخل الرجال ببيتها") or text:match("عير") or text:match("الشاب الأيفع") or text:match("كسمك") or text:match("كس") or text:match("بلاع") or text:match("ابو العيوره") or text:match("منيوج") or text:match("كحبه") or text:match("كحاب") or text:match("الكحبه") or text:match("كسك") or text:match("طيزك") or text:match("كس امك") or text:match("صرم") or text:match("كس اختك")) then
