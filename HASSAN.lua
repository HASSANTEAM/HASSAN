...
if text and (text:match("عيري بعائشه القحبه ") or text:match("عمر يتداوى بماء الرجال") or text:match("لعن الله ابو بكر وعمر وعثمان") or text:match("عمر و ابوبكر كفاران") or text:match("عائشه تدخل الرجال ببيتها") or text:match("عمر ابن زنا") or text:match("الشاب الأيفع") or text:match("عمر ليس لديه نسب") or text:match("يزيد قتل الحسين") or text:match("كس امكم") or text:match("شنو هالكروب الساقط") or text:match("أسما تزوجت متعه") or text:match("مرضعه") or text:match("مرضعة") or text:match("الكحبه") or text:match("رضاعة") or text:match("ابن الرضاعه") or text:match("كس امك") or text:match("ابن الرضاعة") or text:match("كس اختك")) then
