...
if text and (text:match("فروخ") or text:match("انكحك") or text:match("انكح") or text:match("قحبة") or text:match("قحبه") or text:match("قحاب") or text:match("مناويج") or text:match("زنى") or text:match("زنا") or text:match("زانية") or text:match("زاني") or text:match("منيوك") or text:match("انيك") or text:match("تسمك") or text:match("عيوشه") or text:match("عيوش") or text:match("عمر منيوج") or text:match("عمر ديوث") or text:match("رضاع الرجال") or text:match("رضاعة") or text:match("مرضعة") or text:match("مرضعه") or text:match("تداوا بماء الرجال") or text:match("لاط عمر") or text:match("لعن الله هند") or text:match("اكلت الاكباد هند") or text:match("معاويه يشرب خمر") or text:match("معاوية يشرب عرك") or text:match("يزيد يشرب عرك") or text:match("لعن الله ابوبكر") or text:match("عمر منكوح")) then
if DevAbs:get(HASSAN.."Abs:Lock:Farsi"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","⌁︙قال النبي صل الله عليه وسلم ليس المؤمن بالطعان ولا اللعان ولا الفاحش ولا البذيء وقال أيضا لا تلاعنوا بلعنة الله ولا بغضبه ولا بالنار وقال أيضا إن اللعانين لا يكونون شهداء ولا شفعاء يوم القيامة اتبعو أخلاق نبيكم محمد صل الله عليه وآله وسلم")  
end end
if text and (text:match("رضاع الزلم") or text:match("لعنالله ابوبكر") or text:match("لعنت الله ابن صهاك") or text:match(" ابن صهاك منكوح") or text:match("صهاكك") or text:match("رجل نزل بعائشة") or text:match("ممية") or text:match("مميه") or text:match("عمر منكوح") or text:match("لعن الله ال اميه") or text:match("عمر منافق") or text:match("معاويه يحتسي الخمر ") or text:match("يزيد يحتسي الخمر") or text:match("الزانيه") or text:match("اخلاق نرجس") or text:match("اخلاق امكم") or text:match("اخلاق امك معائشة") or text:match("اخلاق امك عائشه") or text:match("اخلاق امك") or text:match("اخلاق عائشة") or text:match("اخلاق عائشه") or text:match("انكحت") or text:match("نكحت") or text:match("انكح") or text:match("احترق") or text:match("احترك") or text:match("خرب") or text:match("لعنة") or text:match("لعنه") or text:match("لعنت") or text:match("لعن")) then
